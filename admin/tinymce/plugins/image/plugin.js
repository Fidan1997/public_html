...
tinymce.PluginManager.add('image', function(editor) {
	function showDialog() {
		...
		win = editor.windowManager.open({
			...
			data: data,
			body: [
				{name: 'src', type: 'filepicker', filetype: 'image', label: 'Select image', autofocus: true},
				{name: 'alt', type: 'textbox', label: 'Alternative Text'},
				...
				]},
				{
					...
					items: [
						...
						{name: 'constrain', type: 'checkbox', checked: true, text: 'Constain'}
					]
				}
			],
			onSubmit: function(e) {
